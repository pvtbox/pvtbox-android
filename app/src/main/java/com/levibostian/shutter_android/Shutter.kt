...
open class Shutter private constructor() {
    ...
    companion object {
        ...
        @JvmStatic fun with(fragment: androidx.fragment.app.Fragment): ShutterCompanion = ShutterCompanion(fragment)
    ...
    class ShutterCompanion {
        ...
        var supportFragment: androidx.fragment.app.Fragment? = null
