...
public class EnterPinActivity extends AppCompatActivity {
    ...
    private static final String EXTRA_FONT_TEXT = "textFont";
    private static final String EXTRA_FONT_NUM = "numFont";

    private static final int PIN_LENGTH = 4;
    private static final String FINGER_PRINT_KEY = "FingerPrintKey";

    private static final String PREFERENCES = Const.SETTINGS_NAME;
    @Nullable
    private static final String KEY_PIN = PreferenceService.encode("enterPinPasscode");
    ...
    @NonNull
    private static Intent getIntent(Context context, String fontText, String fontNum) {
        Intent intent = new Intent(context, EnterPinActivity.class);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (mSetPin) {
            ...
            if (Objects.requireNonNull(pin).equals("")) {
                changeLayoutForSetPin();
                mSetPin = true;
            } else {
                checkForFingerPrint();
    ...
    private void generateKey() throws FingerprintException {
        ...
        } catch (@NonNull KeyStoreException
    ...
    private void writePinToSharedPreferences(@NonNull String pin) {
        SharedPreferences prefs = this.getSharedPreferences(PREFERENCES, Context.MODE_PRIVATE);
        prefs.edit().putString(KEY_PIN, PreferenceService.encode(Utils.sha256(pin))).apply();
    }
    ...
    public static void deletePin(@NonNull Context context) {
        SharedPreferences prefs = context.getSharedPreferences(PREFERENCES, Context.MODE_PRIVATE);
    ...
    private String getPinFromSharedPreferences() {
        SharedPreferences prefs = this.getSharedPreferences(PREFERENCES, Context.MODE_PRIVATE);
        return PreferenceService.decode(prefs.getString(KEY_PIN, ""));
    }

    private void setPin(@NonNull String pin) {
        if (mFirstPin.equals("")) {
            mFirstPin = pin;
    ...
    private void checkForFingerPrint() {
        ...
        final FingerPrintListener fingerPrintListener = new FingerPrintListener() {
            ...
            public void onSuccess() {
                setResult(RESULT_OK);
                Animate.animate(mImageViewFingerView, Objects.requireNonNull(fingerprintToTick));
            ...
            public void onFailed() {
                Animate.animate(mImageViewFingerView, Objects.requireNonNull(fingerprintToCross));
                final Handler handler = new Handler();
                handler.postDelayed(() -> Animate.animate(mImageViewFingerView, Objects.requireNonNull(showFingerprint)), 750);
            }
...
//                    mTextFingerText.setVisibility(View.GONE);
                ...
                if (!Objects.requireNonNull(mFingerprintManager).hasEnrolledFingerprints()) {
...
//                    mTextFingerText.setVisibility(View.GONE);
                ...
                if (!Objects.requireNonNull(mKeyguardManager).isKeyguardSecure()) {
